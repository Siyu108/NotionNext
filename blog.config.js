...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是侯思宇, 这里是我与家人充满爱的空间 🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Molly6', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '侯思宇', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'molly6love.space', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'FamilyBlog, 侯思宇家庭博客，家庭博客', // 网站关键词 英文逗号隔开
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      name: '风',
      artist: '鲸鱼马戏团',
      url: 'https://c6.y.qq.com/base/fcgi-bin/u?__=XtUbF0',
      cover:
            'https://plus.unsplash.com/premium_photo-1664361482008-dd009b17b1b3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8dHVuZHJhfGVufDB8fDB8fHww&auto=format&fit=crop&w=800&q=60'
    },
  ],
  ...
  COMMENT_UTTERRANCES_REPO:
        process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || 'Siyu108/NotionNext', // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/

  // giscus @see https://giscus.app/
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'Siyu108/NotionNext', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  ...
  COMMENT_GITALK_REPO: process.env.NEXT_PUBLIC_COMMENT_GITALK_REPO || 'Siyu108/NotionNext', // 你的Github仓库名，例如 'NotionNext'
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Molly6Love BLOG', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
